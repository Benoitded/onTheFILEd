    ...
    <footer>
        <div className="footer-dark">
            <div className="row">
                ...
                <div className="col item social" style={{flexDirection:'row',display:'flex',justifyContent:'center',alignItems:'center'}}>
                    ...
                    <a href="#" style={{alignItems:'center',justifyContent:'center'}} >
                        <Icon icon="ion-social-instagram" style={{ fontSize: '20px',alignItems:'center',justifyContent:'center' }}/>
                    </a>
                </div>
            </div>
